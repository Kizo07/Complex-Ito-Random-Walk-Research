...
- Extended grid (revised 2026-09-03, oracle-based): PPA RMSE $0.0146$
  / MAE $0.0026$ vs BAW $0.279/0.162$; the boundary's approach to the
  perpetual limit is shown to be non-exponential ($r=q$ degeneracy of
  the linearized memory kernel), which justifies pinning over decay
  extrapolation. All formulas raw (no hidden clipping); no stationarity
  claims.
...
- Full suite green on 2026-08-21 (182 s) and 2026-09-03 (227 tests,
  203 s; Phase 15 Revision 2 + Phase 16, after external mathematical
  review).
