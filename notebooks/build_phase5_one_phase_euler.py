"""Build the deterministic Phase 5 one-phase Euler research notebook."""
...
cells = [
    md(
        r"""
        # Phase 5: exact one-phase Euler representations

        This notebook is the reproducible computational record for the Phase 5
        research question
    ...
    code(
        ...
        EVIDENCE = ROOT / "phase5_evidence"
        RASTER = ROOT / "phase5_figures" / "raster"
        VECTOR = ROOT / "phase5_figures" / "vector"
    ...
    code(
        ...
        ax.set_title("Phase 5 implication decisions", fontsize=14, pad=20)
    ...
    md(
        r"""
        ## 19. Final computational conclusion
...
for index, cell in enumerate(cells):
    ...
    cell["id"] = f"phase5-{index:02d}-{source_digest}"
...
output = Path(__file__).with_name("phase5_one_phase_euler.ipynb")
